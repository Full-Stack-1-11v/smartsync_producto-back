...
public class ProductoControllerTest {
    ...
    @Test
    @DisplayName("GET api/v1/ecomarket/producto Devuelve un 200(ok) si encuentra datos")
    ...
    @Test
    @DisplayName("GET /api/v1/ecomarket/producto Devuelve un 204(NotContent) si no hay contenido") 
    ...
    @Test
    @DisplayName("GET /api/v1/ecomarket/producto/{id}/buscar Busca un producto y devuelve un 200(Ok) si lo encuentra")
    void findProductoByIdTest() throws Exception{
        Producto producto = new Producto(1L, "papa", 1000, 10);
        when(productoService.findById(1L)).thenReturn(producto);

        mockMvc.perform(get("/api/v1/ecomarket/producto/1/buscar")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    @Test
    @DisplayName("GET /api/v1/ecomarket/producto/{id}/buscar buscar un producto y devuelve un 204(Not Found)")
    ...
    @Test
    @DisplayName("POST /api/v1/ecomarket/producto/guardar Guarda un producto y devuelve un 201(Created)")
    void saveProductosTest() throws Exception {
        Producto producto = new Producto(1L, "papa", 1000, 10);
        when(productoService.save(producto)).thenReturn(producto);

        mockMvc.perform(post("/api/v1/ecomarket/producto/guardar")
    ...
    @Test
    @DisplayName("PUT /api/v1/ecomarket/producto/{id}/actualizar Actualiza un producto y devuelve un 200(ok)")
    void updateProductoByIdTest() throws Exception{
        ...
        mockMvc.perform(put("/api/v1/ecomarket/producto/1/actualizar")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @DisplayName("PUT /api/v1/ecomarket/producto/{id}/actualizar Devuelve un 204 al no encontrar el producto")
    ...
    @Test
    @DisplayName("DELETE /api/v1/ecomarket/producto/1/eliminar Elimina un producto y devuelve un 204(NoContent)")
    void deleteProductoByIdTest() throws Exception{
        mockMvc.perform(delete("/api/v1/ecomarket/producto/1/eliminar")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());
    }
    ...
    @Test
    @DisplayName("DELETE /api/v1/ecomarket/producto/1/eliminar Devuelve un 404 si no existe el producto")
    ...
    @Test
    @DisplayName("GET /api/v1/ecomarket/producto/pedidos Devuelve un 200(ok) si encuentra pedidos")
    void findPedidosApiTest()throws Exception{
        ...
        mockMvc.perform(get("/api/v1/ecomarket/producto/pedidos")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(2));
    }
    ...
    @Test
    @DisplayName("GET /api/v1/ecomarket/producto/pedidos devuelve un 204(noContent) al no encontrar pedidos")
